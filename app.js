...
function loadCurrentCard() {
    ...
    const catMap = { 'פרשת בא': 'category-ba', 'פרשת שמות': 'category-shmot', 'פרשת וארא': 'category-vaera', 'פרשת בשלח': 'category-beshalach', 'פרשת משפטים': 'category-mishpatim', 'פרשת תרומה': 'category-truma', 'פרשת תצוה': 'category-tetzave', 'פרשת כי תשא': 'category-kitisa' };
